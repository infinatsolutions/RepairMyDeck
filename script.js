(function () {
  ...
  function setupContactForm() {
    ...
    form.addEventListener("submit", async function (event) {
      ...
      if (form.action.indexOf("formsubmit.co") !== -1) {
        // For static hosting, submit directly to FormSubmit so email delivery works without PHP.
        form.submit();
        return;
      }
      ...
      try {
        ...
        setStatus(status, "Submission failed. Please retry in a moment or email repairmydeck@iCloud.com.", "error");
      }
    });
  }
